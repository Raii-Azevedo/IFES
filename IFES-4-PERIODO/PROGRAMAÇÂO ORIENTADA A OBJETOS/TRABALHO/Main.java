...
public class Main {
    ...
    public static void main(String[] args) {
        showMenu(); // Exibe a mensagem do sistema ao iniciar o programa
        carregarAlunosDoArquivo(); // Carrega os alunos do arquivo ao iniciar o programa
        while (true) {
    ...
    private static void cadastrarAluno() {
        ...
        salvarAlunosEmArquivo(); // Salva os alunos no arquivo ao cadastrar um novo aluno
